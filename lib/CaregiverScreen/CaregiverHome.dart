...
import 'CaregiverBottomNavBar.dart'; // Assuming this exists
              ...
              DrawerHeader(
                ...
                child: StreamBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    String fullName = snapshot.data!.get('fullName') ?? 'Caregiver';
                    return Column(
                      ...
                      children: [
                        const CircleAvatar(
                          radius: 40,
                          backgroundImage: AssetImage('assets/caregiver_avatar.png'),
                  ...
                  children: [
                    ...
                    StreamBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        String caregiverName = snapshot.data!.get('fullName') ?? 'Caregiver';
                        return Text(
                          'Hello $caregiverName!',
                          style: GoogleFonts.balsamiqSans(
                            fontSize: 28,
                            ...
                            children: [
                              _buildFunCard(
                                ...
                                "Kid's Progress Report",
                                    () => Navigator.pushNamed(context, '/caregiverViewReport'),
                              ),
                            ],
                          ),
                        ],
