...
class KidChangePassword extends StatefulWidget {
  const KidChangePassword({super.key});

  @override
  _KidChangePasswordState createState() => _KidChangePasswordState();
}

class _KidChangePasswordState extends State<KidChangePassword> {
